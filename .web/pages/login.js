...
export default function Component() {
  ...
  <Container centerContent={true} sx={{"background-image": "url('favicon.ico')", "background-size": "cover", "background-repeat": "no-repeat", "maxWidth": "auto", "maxHeight": "auto", "height": "100vh"}}>
