...
export default function Component() {
  ...
  <Container centerContent={true} sx={{"background-image": "url('/aurora1.jpg')", "background-size": "cover", "maxWidth": "auto", "maxHeight": "auto", "height": "100vh"}}>
  <Container sx={{"height": "210px"}}/>
